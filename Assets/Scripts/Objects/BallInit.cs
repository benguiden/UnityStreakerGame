...
public class BallInit : MonoBehaviour {
	...
	public void Init(float velo){
		...
		Vector3 newVelo = (-this.transform.position.normalized + new Vector3(Random.Range(0f, 0.25f), Random.Range(0f, 0.25f), Random.Range(0f, 0.25f))) * (velo * Random.Range(0.8f, 1.2f));
